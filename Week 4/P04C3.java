 ...
 public class P04C3
   {
      ...
      Scanner keyboardIn = new Scanner(System.in);
         ...
         {
         nyTime = time - 5;
         System.out.println ("The time in New York is: " +nyTime);
         
         sfTime = time - 8; 
         System.out.println ("The time in San Fransisco is: " +sfTime);
         
         sidneyTime = time + 10;
         System.out.println ("The time in Sidney is: " +sidneyTime);
         }
