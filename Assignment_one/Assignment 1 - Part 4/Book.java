...
public class Book
{
   ...
   // tostring returns name of book by how many Authors and author name
   public String toString()
   {  
   String str=" ";
   for (int b=0; b<numAuthors; b++)
   {
   str= name +" by " +numAuthors +" authors " +authors[b].getName();
   }
      return str;
   }
   // print names of all authers in array
